...
//--------------------------------------------------------------------------------
	...
	private fun handleActionOnAttachDevice(intent: Intent) {
		...
		if (hasPermission) {
			log("INFO VP", "hasPermission = true")
		} else {
			log("INFO VP", "hasPermission = false")
		}
		...
		if (device != null) {
			...
			if (manager.hasPermission(device)) {
				log("INFO VP", "managerHasPermission = true")
			} else {
				log("INFO VP", "managerHasPermission = false")
			}

			if (!hasPermission) {
				log("INFO VP", "hasPermission = false - request permission")
